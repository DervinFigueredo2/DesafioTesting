package com.desafio.TuCasitaTasaciones.controller.advice;

import com.desafio.TuCasitaTasaciones.dto.error.ErrorDTO;
...
public class ExceptionControllerAdvice {
    ...
    public ErrorDTO handleUserNotFoundException(NoSuchFieldException e) {
    ...
    public ResponseEntity MethodArgumentNotValidExceptionHandler(MethodArgumentNotValidException e) {
        ...
        return new ResponseEntity<>(new ErrorDTO("Informacion no valida", String.join(", ", ListErrors),
                LocalDateTime.now()),
